...
\item
  ...
  \item
    Also be sure to check the box to install \texttt{pip}, which is how
    you download other useful Python tools!
  \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Using Python via JupyterLab}
\phantomsection\label{using-python-via-jupyterlab}
\begin{itemize}
\tightlist
\item
  \textbf{Step 1: Install JupyterLab}:

  \begin{itemize}
  \tightlist
  \item
    Install with \texttt{pip\ install\ jupyterlab} in your terminal.
  \end{itemize}
\item
  \textbf{Step 2: Using JupyterLab}:

  \begin{itemize}
  \tightlist
  \item
    Start a notebook by typing \texttt{jupyter\ lab} in your terminal.
  \end{itemize}
\end{itemize}
\end{frame}
